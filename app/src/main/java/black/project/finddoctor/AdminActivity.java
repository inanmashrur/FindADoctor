    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Id.isEmpty() | Name.isEmpty()| picURL.isEmpty()| Speciality.isEmpty()| Fee.isEmpty()| Chamber.isEmpty()| Location.isEmpty()| Contact.isEmpty()| Schedule.isEmpty()| About.isEmpty()){
