...
import black.project.finddoctor.LoginActivity;
...
public class TopDoctorAdapter extends RecyclerView.Adapter<TopDoctorAdapter.DoctorViewHolder> {
    ...
    public TopDoctorAdapter(Context mContext, List<Doctor> mData) {
    ...
    public DoctorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View Layout;
        Layout = LayoutInflater.from(mContext).inflate(R.layout.card_top_doctors,parent,false);
    ...
    public static class DoctorViewHolder extends RecyclerView.ViewHolder {
        ...
        public DoctorViewHolder(@NonNull View itemView) {
            ...
            container = (LinearLayout) itemView.findViewById(R.id.LL_top_doctors);
            //picURL = (TextView) itemView.findViewById(R.id.TV_date1);
            tv_name = (TextView) itemView.findViewById(R.id.TV_doc_name);
            tv_speciality = (TextView) itemView.findViewById(R.id.TV_doc_speciality);
